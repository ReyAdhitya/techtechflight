...
function epicBody(section, features) {
  const rows = features
    ...
    .join('\n')
  return `Part of the 350-feature map — see \`docs/BACKLOG.md\` and \`docs/agents/cursor/features.tsv\`.
...
**Size** ${feature.size} · **Wave** ${feature.wave} · **Feature** ${feature.num} of 350
...
const backlog = `# Backlog — the 350-feature map
