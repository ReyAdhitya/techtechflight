...
var Classroom = class {
  ...
  async fetch(request) {
    ...
    if (request.method === "GET") {
      ...
      if (stored === void 0) return json({ error: "No classroom with that code yet." }, 404);
...
// .wrangler/tmp/bundle-3uUgaV/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-3uUgaV/middleware-loader.entry.ts
