...
- **Note:** School stream map landed in #50 (Settings/env + native `<video>`). Overlay
  detection is #49 — still not on the Telemetry wire. Even-index classroom craft already
  have `hasCamera` in the simulator.
